...
#     _db_type = "MongoDB"
#
#     def __init__(self, uri: str = setting.db.nosql.uri, db_name: str = "default", **kwargs):
#         """
...
#         """
#         self.uri = uri
#         # Create a MongoClient connection object
#         self._client = self.connect()
#         # Get the specified database by name
#         self._db_obj = self._client[db_name]
#         # The currently active collection (similar to a table in TinyDB)
...
#     def table(self):
#         """
#         Return the current active collection.
#
#         Raises:
#             ValueError: If the collection is not set, please call `get_table(collection_name)` first.
#         """
#         if self._collection_obj is None:
#             raise ValueError(
#                 "Collection object is not defined. Please call `get_table(collection_name)` first."
#             )
...
#             return self._db_obj[collection_name]
#         else:
#             # The create_collection method will raise an exception if the collection exists,
#             # so we check for its existence first.
#             return self._db_obj.create_collection(collection_name, **kwargs)
#
#     def get_table(self, collection_name: str, **kwargs):
#         """
...
#             self
#         """
#         self._collection_obj = self._db_obj[collection_name]
#         return self
#
#     def table_list(self):
#         """
...
#         """
#         return self._db_obj.list_collection_names()
#
...
#         """
#         return self._db_obj.drop_collection(collection_name)
#
...
#
#     def _build_query_mongo(self, mongo_query: dict) -> dict:
#         """
...
#         return list(self.table.find(filter_query))
#
...
#         result = self.table.update_many(filter_query, {"$set": update_data})
...
#         """
#         filter_query = self._build_query_mongo(query)
#         result = self.table.delete_many(filter_query)
